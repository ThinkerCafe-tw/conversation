...
class IntentAnalyzer:
    def __init__(self, graph: KnowledgeGraph = None):
        ...
        self.feature_keywords = {
            "接龍": ["接龍", "文字接龍", "詞語接龍", "玩接龍", "玩文字接龍", "怎麼玩接龍", "接龍遊戲", "文字接龍遊戲", "開始接龍"],
            "投票": ["投票", "表決", "選擇", "票選", "選舉", "我想投票", "發起投票", "怎麼投票", "投票給", "建立投票", "參與投票"],
            "統計": ["統計", "查看統計", "進度", "排行", "數據", "看數據", "數據如何", "給我統計資料", "頻率統計", "查看進度", "貢獻排行", "資料統計"],
            "廣播": ["廣播", "頻率", "查看廣播", "最新廣播", "聽廣播", "最新消息", "今天的廣播", "頻率共振內容", "念廣播", "播報"],
            "防空": ["防空", "避難", "避難所", "防災", "躲避", "避難所資訊", "哪裡有避難所", "緊急避難", "安全地點", "空襲躲哪"], # "防災" is broad, kept here for now
            "物資": ["物資", "補給", "用品", "援助", "分享", "物資分享", "我需要物資", "哪裡有物資", "提供物資", "請求物資"],
            "API統計": ["API", "用量", "使用量", "API統計", "API用量查詢", "API額度", "Gemini API"],
            "幫助": ["幫助", "help", "說明", "怎麼用", "教學", "指令", "功能列表", "有哪些功能", "我該怎麼做", "使用手冊", "操作說明"],
            "笑話": ["笑話", "說個笑話", "來個笑話", "有好笑的嗎", "聽個笑話", "我想說笑話", "分享笑話", "講笑話", "幽默"]
        }
        
        # 意圖模式
        self.intent_patterns = {
            "查詢": ["查看", "查詢", "看看", "顯示", "告訴我", "是什麼", "在哪裡", "有多少", "我想知道", "告訴我關於", "解釋一下", "目前狀況"],
            "開始": ["開始", "啟動", "發起", "玩", "來", "我要開始", "建立一個", "弄一個", "我想玩", "啟動功能"],
            "參與": ["參加", "加入", "我要", "一起", "我也要", "算我一份", "怎麼加入", "我想參加", "一起玩"],
            "分享": ["分享", "提供", "給", "有", "我想提供", "這裡有", "登錄這個", "我要分享", "發布"],
            "結束": ["結束", "停止", "不玩了", "停止遊戲", "不要了", "結束目前功能"]
        }
